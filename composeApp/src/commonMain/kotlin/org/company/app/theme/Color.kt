...
@Stable
class Gradient private constructor(val colors: List<Color>) {
    companion object {
        operator fun invoke(start: Color, end: Color): Gradient {
            return Gradient(listOf(start, end))
        }

        operator fun invoke(single: Color): Gradient {
            return Gradient(listOf(single, single))
        }
    }
...
val Grey = Color(0xFFB1ADAD)
val PurpleGrey40 = Color(0xFF625b71)
val Pink40 = Color(0xFF7D5260)

val White = Color(0xFFFFFFFF)
val MainGrey = Color(0xFF4A4A4A)

val Promotion = Gradient(
    start = Color(0xFFE2444F),
    end = Color(0xFFAA5481)
)

val Transparent = Gradient(
